...
print("BREVO SENDER:", app.config.get("BREVO_SENDER_EMAIL"))
...
"""
    ...
    # Send emails via Brevo (HTTPS API, works on Render free tier)
    try:
        print("Sending admin notification...")
        send_email(
            to_email="ampuriraphilbert@gmail.com",
            to_name="Ampurira Philbert",
